...
public class CustomExceptionHandler {
    ...
    public ErrorResponse handleBadCredentialsException(BadCredentialsException ex, WebRequest request){
        ...
        return  new ErrorResponse(HttpStatus.UNAUTHORIZED, ex.getMessage(), System.currentTimeMillis());
    ...
    public ErrorResponse handleConflictException(ConflictException ex, WebRequest request){
        ...
        return  new ErrorResponse(HttpStatus.CONFLICT, ex.getMessage(), System.currentTimeMillis());
